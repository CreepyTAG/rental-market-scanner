...
CREATE TABLE IF NOT EXISTS listings (
    ...
    note_proprete   DOUBLE,
    note_precision  DOUBLE,
    note_arrivee    DOUBLE,
    note_communication DOUBLE,
    note_emplacement   DOUBLE,
    note_qualite_prix  DOUBLE,
    -- Logement
    amenities       VARCHAR,
    -- Meta
    url             VARCHAR,
...
def upsert_listing(conn: duckdb.DuckDBPyConnection, listing: dict) -> tuple[str, str]:
    ...
    fields = [
        ...
        ("note_proprete",       listing.get("note_proprete")),
        ("note_precision",      listing.get("note_precision")),
        ("note_arrivee",        listing.get("note_arrivee")),
        ("note_communication",  listing.get("note_communication")),
        ("note_emplacement",    listing.get("note_emplacement")),
        ("note_qualite_prix",   listing.get("note_qualite_prix")),
    ...
    conn.execute(
        ...
        [
            ...
            listing.get("note_proprete"), listing.get("note_precision"), listing.get("note_arrivee"),
            listing.get("note_communication"), listing.get("note_emplacement"), listing.get("note_qualite_prix"),
